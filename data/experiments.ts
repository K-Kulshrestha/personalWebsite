...
export const experiments: Experiment[] = [
  {
    ...
    links: [{ href: "https://github.com/hemkan/swift-cards", label: "GitHub" }],
    color: "sticky",
  },
  {
    id: "elmo",
  ...
  },
  {
    ...
    details: [
      "ACM Research team project, Spring 2024 (five students, with mentors)",
      "Multimodal: BERT for text, ResNet-18 for images, combined with late fusion",
      "Trained on SemEval 2021 posts labelled with 22 possible persuasion techniques",
      "89.2% overall accuracy",
    ],
    stack: ["Python", "PyTorch", "BERT", "ResNet-18"],
    metric: "89.2%",
    figure: {
      src: "/images/research/poster-1600.webp",
      thumb: "/images/research/poster-700.webp",
      width: 1600,
      height: 960,
      alt: "The Feelings Behind Words research poster: introduction, data collection, model architecture, results chart and conclusion.",
      caption: "Our ACM Research poster, Spring 2024.",
    },
    links: [{ href: "/research/feelings-behind-words.pdf", label: "View research poster" }],
    color: "blue",
  },
  {
    id: "ux-rebrand",
    ...
    figure: {
      src: "/images/ux-club/site-home-1600.webp",
      thumb: "/images/ux-club/site-home-800.webp",
      width: 1600,
      height: 792,
      alt: "The UX Club website home page: 'We help design the future by empowering UT Dallas students through user-centric design', with the club's phone mascot and event photos.",
      caption: "uxutd.com: the club site I worked on, still live.",
    },
    links: [{ href: "https://www.uxutd.com/", label: "Visit live site" }],
    color: "paper",
  },
  {
    id: "design-a-thon",
