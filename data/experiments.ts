...
export const experiments: Experiment[] = [
  ...
  },
  {
    ...
    name: "Elmo",
    status: "prototype",
    because: "I had twelve tabs open about one news story",
    what: "Multi-source news with grounded AI summaries.",
    details: ["RAG with Pinecone", "Serverless AWS", "Constrained prompts so it doesn't make things up"],
    stack: ["Next.js", "AWS", "Pinecone", "DeepSeek"],
    caseStudy: "elmo",
    color: "white",
  },
  {
